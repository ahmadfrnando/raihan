...
<body>
    ...
    <div class="container">
        ...
        <div class="button-container">
            <a href="{{ route('admin.tambah-jadwal-dokter') }}"><button class="button">Tambah Jadwal Dokter</button></a>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <a href="/admin/hapus-jadwal-dokter/{{ $d->id }}"><button class="delete">Hapus</button></a>
                    </td>
                    @endforeach
                </tr>
            </tbody>
